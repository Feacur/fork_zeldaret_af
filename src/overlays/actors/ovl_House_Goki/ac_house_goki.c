...
void func_80A83D4C_jp(House_Goki* this, Game_Play* game_play) {
    ...
    if (this->actor.speed != 0.0f) {
        ...
        if ((this->actor.colCheck.colResult.hitWall & 2) || (this->actor.colCheck.colResult.unk1 & 2) ||
            ...
            temp_v0_3 = mFI_GetUnitFG(this->actor.world.pos);
            if ((temp_v0_3 != NULL) && (*temp_v0_3 == 0x1F3F)) {
                this->unk_188 = 0;
    ...
    if (((game_play->unk_1EA0 % 100) < 0x15) && !(fqrand() < 0.5f)) {
        if (!(this->actor.xzDistToPlayer < 60.0f)) {
            ...
            sp34.x += 80.0f - (fqrand() * 160.0f);
            sp34.z += 80.0f - (fqrand() * 160.0f);
            this->actor.shape.rot.y = search_position_angleY(&this->actor.world.pos, &sp34);
            this->unk_195 = 0;
            this->actor.world.rot.y = this->actor.shape.rot.y;
            this->actor.speed = 4;
        }
